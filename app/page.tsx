  ...
  return (
    <section className={styles.hero} id="product">
      <div className={styles.heroCopy}>
        <p className={styles.eyebrow}>Automated filing for RIA client uploads</p>
        <h1>File client uploads without the manual cleanup.</h1>
        <p className={styles.lead}>
          RIA File Ops detects new uploads, identifies each document, applies
          your firm&apos;s naming rules, and prepares the destination so your team
          can approve and file faster.
        </p>
  ...
  return (
    <section className={styles.finalCtaSection} aria-labelledby="final-cta">
      <div className={styles.finalCtaCard}>
        ...
        <h2 id="final-cta">Stop filing client uploads by hand.</h2>
        <p className={styles.finalCtaSupport}>
          Join the waitlist for automated filing built around RIA naming rules
