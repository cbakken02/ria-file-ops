...
export const metadata: Metadata = {
  ...
  description:
    "Join the RIA File Ops waitlist for document intelligence built for RIA operations teams.",
};
      ...
      <section className={styles.hero} aria-labelledby="waitlist-heading">
        <div className={styles.copyPanel}>
          ...
          <p className={styles.lead}>
            RIA File Ops helps advisory teams clean up files, extract useful
            client and account signals, and prep reviewable advisor workflows.
            Tell us where your files live today and we&apos;ll follow up when
            we&apos;re ready to onboard more firms.
          </p>
